...
public class ExpertsResp implements Serializable {
	 ...
	 * 品种
	 */
	private List<ProductLibraryTreeListResp> pltListResp;
	...
	public List<ProductLibraryTreeListResp> getPltListResp() {
		return pltListResp;
	}

	public void setPltListResp(List<ProductLibraryTreeListResp> pltListResp) {
		this.pltListResp = pltListResp;
	}
