...
public class AgroBaseTreeReq implements Serializable {
	 ...
	 * 负责人角色id
	 */
	private String isAdminRoleId;
	/**
	 * 农户角色id
	 */
	private String artisanRoleId;
	/**
	 * 展示URL
	 */
	...
	public String getIsAdminRoleId() {
		return isAdminRoleId;
	}

	public void setIsAdminRoleId(String isAdminRoleId) {
		this.isAdminRoleId = isAdminRoleId;
	}

	public String getArtisanRoleId() {
		return artisanRoleId;
	}

	public void setArtisanRoleId(String artisanRoleId) {
		this.artisanRoleId = artisanRoleId;
	}
