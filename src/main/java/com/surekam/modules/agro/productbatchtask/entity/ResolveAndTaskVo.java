...
public class ResolveAndTaskVo {
	...
	public ResolveAndTaskVo() {
		super();
	}

	public ResolveAndTaskVo(String taskId, String taskResoleId, String standardItemName, String dispatchTime,
