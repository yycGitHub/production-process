...
@DynamicInsert
@DynamicUpdate
public class ProductionBatchReport extends XGXTEntity<ProductionBatchReport> {
	...
	private String baseAcreage; // 基地面积

	public ProductionBatchReport() {
		super();
	}
	...
	@Transient
	public String getBaseAcreage() {
		return baseAcreage;
	}

	public void setBaseAcreage(String baseAcreage) {
