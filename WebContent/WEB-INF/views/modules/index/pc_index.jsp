...
<body>
	...
	<div class="warpper">
	  ...
	  <div class="f_l show">
	    ...
	    <div id="yl" class="f_l maxbox show_bg">
	      ...
	      <div class="mobile"><iframe class="framing" name="view" id="view" src='${pageContext.request.contextPath}/v.html?traceCode=10002900012018114201812' frameborder="0" width="100%" height="100%"></iframe></div>
	      <div class="show_btn">
	        <ul>
	...
	<script type="text/javascript">
	    ...
	    function lookPC(obj,count,productId){
	    	...
	    	if(count>0){
				...
				if(!$(obj).hasClass("seecur")){
					...
					if(flag){
						document.getElementById("view").src = '${pageContext.request.contextPath}/v.html?traceCode=10002900012018114201812';
						document.getElementById("bg").style.display ="block";
						document.getElementById("show").style.display ="block";
						flag = false;
					}
		...
		function show(batchId){
			document.getElementById("view").src = '${pageContext.request.contextPath}/src/traceInfoPreview.html?batchId='+batchId;
	    }
